...
The questions in the guessing game must require a mix of yes/no answers, and user input must accept eit
her y/n or yes/no responses, with either .toUpperCase() or .toLowerCase() used to validate the user input and accommodate users entering all-caps Y/N or YES/NO answers, too.
...
if(answer1 === 'n' || answer1 === 'no') {
  ...
  alert('Yes, she is fluffy, thanks for noticing');
}
...
if(answer4 === 'n' || answer4 === 'no') {
  alert('You are wrong, although I guess it depends on whether it\'s summer or not');
} else {
